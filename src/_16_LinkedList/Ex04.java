...
public class Ex04 {
    ...
    public static void main(String[] args) {
         ...
         LinkedList<String >ll1=new LinkedList<>(Arrays.asList("haluk","ipek","harun"," irem")); // liste direk ekleme yaptik
         Scanner scan=new Scanner(System.in);
         System.out.println("isim giriniz :  ");

        String isim=scan.nextLine().toLowerCase();
        if (ll1.remove(isim)){ //true yada false dondurur
            System.out.println("Bu isim LinkedList'de vardi ve silindi");
            System.out.println(ll1); // silinmis halini yazdirdi
